...
from thefeck.output_readers import rerun


class TestRerun(object):
    def setup_method(self, test_method):
        self.patcher = patch('thefeck.output_readers.rerun.Process')
    ...
    @patch('thefeck.output_readers.rerun._wait_output', return_value=False)
    @patch('thefeck.output_readers.rerun.Popen')
    ...
    @patch('thefeck.output_readers.rerun._kill_process')
    ...
    @patch('thefeck.output_readers.rerun.logs')
