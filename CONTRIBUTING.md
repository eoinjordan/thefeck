# Report issues
If you have any issue with The Feck, sorry about that, but we will do what we
...
the following basic information:
  - the output of `thefeck --version` (something like `The Feck 3.1 using
    Python 3.5.0`);
...
Install `The Feck` for development:
